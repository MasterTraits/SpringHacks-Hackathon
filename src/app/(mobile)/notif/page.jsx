    ...
    <main className="h-[92vh] mb-16 overflow-y-auto bg-background">
      <section className="pt-5 px-5 mb-2 flex justify-between"> 
        ...
        <div className="flex gap-3 items-center">
          <a className="badge badge-success">+Number</a>
      ...
      <article className="flex items-center justify-between h-auto px-6 py-4 border-b-[1px] border-neutral-800">
        <div className="flex gap-3 items-center">
          ...
          <div className="*:p-0 *:m-0">
            <p className="border-neutral-700 text-sm">Time here</p>
            <h3 className="text-md font-semibold">Welcome to the community!</h3>
            <p className="border-neutral-600 text-sm">Message here</p>
          </div>
        </div>
